...
Once completed, you can disable the plug-in and remove it. It only works when activated.
...
Une fois terminé, vous pouvez désactiver le plug-in et le retirer. Il fonctionne uniquement lors de l’activation.
